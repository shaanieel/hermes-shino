...
ALWAYS design mobile-first. Every page MUST work perfectly on:
- Mobile: 320px-767px (single column, touch-friendly, minimum 44px tap targets)
- Tablet: 768px-1023px
- Desktop: 1024px+

Key mobile rules:
- Use CSS Grid + flexbox with mobile-first breakpoints (min-width, not max-width)
- Hamburger menu or bottom nav for mobile navigation
- Images must be responsive (max-width: 100%, srcset where appropriate)
- Font sizes must be readable on small screens (minimum 16px body text)
